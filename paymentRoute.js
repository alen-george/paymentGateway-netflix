...
const netflixBrowsePage = 'http://localhost:3000'
const backEndCallback =' http://localhost:5000'
...
router.post("/payment", (req, res) => {
  ...
  (params["MID"] = process.env.PAYTM_MID),
    ...
    (params["CALLBACK_URL"] = `${backEndCallback}/api/callback`),
    (params["EMAIL"] = mail),
    (params["MOBILE_NO"] = mail);
